...
@section('content')
    ...
    <div class="modal fade" id="payStatusChangeModal" tabindex="-1" aria-labelledby="payStatusChangeModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="payStatus ChangeModalLabel">{{ __('Payment Status Change') }}</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                        <span class="iconify" data-icon="akar-icons:cross"></span>
                    </button>
                </div>
                        ...
                        <div class="modal-inner-form-box bg-off-white theme-border radius-4 p-20 mb-20 pb-0">
                            <div class="row">
                                <div class="col-md-12 mb-25">
                                    ...
                                    <select class="form-select flex-shrink-0" name="status" id="payment-status">
                                        <option value="">--{{ __('Select Option') }}--</option>
                                        <option value="0">{{ __('Partial Payment') }}</option>
                                        <option value="1">{{ __('Full Payment') }}</option>
                                    </select>
                                </div>
                                <div class="col-md-12 mb-25" id="amount-option" >
