<ul class="account-settings-menu list-group">
    ...
    <li><a href="{{ route('owner.tenant.details', [$tenant->id, 'tab' => 'payment']) }}" class="account-settings-menu-item {{ @$navTenantPaymentActiveClass }}"><i class="ri-bank-card-fill"></i>{{ __('Payments') }}</a></li>
